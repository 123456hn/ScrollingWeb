        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group search">
                    <input type="text" class="form-control py-2"  name="search" placeholder="Search for...">
                    <span class="input-group-btn">
                        <input class="btn btn-default bg-dark"  type="submit" value="Search" />
                    </span>
                </div>
                </form>
            </div>
                ...
                <ul class="menu-list bg-dark">
                    ...
                    if(count($result) > 0){
                        foreach($result as $res){ ?>
                           <li><a href="category.php?cat=<?php echo $res['sub_cat_id']; ?>" class="btn-green"></style><?php echo $res['sub_cat_title']; ?></a></li>
                        <?php    }
                    } ?>
                </ul>
            </div>
