        ...
        <div class="row" >
            <div class="col-md-12" >
                <div class="banner-content">
                    <div class="banner-carousel owl-carousel owl-theme w-100 h-100"  >
                        <div class="item">
                            <img src="images/GymGloves.png" alt="" style="height: 60vh"/>
                        </div>
                        <div class="item">
                            <img src="images/Boxing.png" alt="" style="height: 50vh"/>
                        </div>
                        <div class="item">
                            <img src="images/Punching.png" alt="" style="height: 50vh"/>
                        </div>
                    </div>
                </div>
            </div>
